package com.llft.controller.${packageName}.${objectNameLower};
...
import com.llft.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.llft.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
