package com.llft.controller.system.createcode;
...
import com.llft.service.system.createcode.CreateCodeManager;
import com.llft.util.AppUtil;
import com.llft.util.DateUtil;
import com.llft.util.DelAllFile;
import com.llft.util.FileDownload;
import com.llft.util.FileZip;
import com.llft.util.Freemarker;
...
public class CreateCodeController extends BaseController {
	...
	public void save(PageData pd) throws Exception{
		...
		pd.put("TABLENAME", pd.getString("tabletop")+",llft,"+pd.getString("objectName").toUpperCase());	//表名
