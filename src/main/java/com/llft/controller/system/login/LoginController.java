package com.llft.controller.system.login;
...
import com.llft.service.fhoa.datajur.DatajurManager;
import com.llft.service.system.appuser.AppuserManager;
import com.llft.service.system.buttonrights.ButtonrightsManager;
import com.llft.service.system.fhbutton.FhbuttonManager;
import com.llft.service.system.fhlog.FHlogManager;
import com.llft.service.system.loginimg.LogInImgManager;
import com.llft.service.system.menu.MenuManager;
import com.llft.entity.system.Menu;
import com.llft.entity.system.Role;
import com.llft.entity.system.User;
import com.llft.service.system.role.RoleManager;
import com.llft.service.system.user.UserManager;
import com.llft.util.AppUtil;
import com.llft.util.Const;
import com.llft.util.DateUtil;
import com.llft.util.Jurisdiction;
import com.llft.util.PageData;
import com.llft.util.RightsHelper;
import com.llft.util.Tools;
/**
 * 总入口
 * @author llft QQ 3 1 3 5 9 6 7 9 0[青苔]
 * 修改日期：2015/11/2
 */
/**
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("qq565848579llft", "").replaceAll("qq565848579llft", "").split(",llft,");
