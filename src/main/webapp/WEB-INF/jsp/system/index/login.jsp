	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qq565848579llft"+loginname+",llft,"+password+"qq565848579llft"+",llft,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
	...
	function register(){
		if(rcheck()){
			...
			$.ajax({
		    	...
		    	data: {USERNAME:$("#USERNAME").val(),PASSWORD:$("#PASSWORD").val(),NAME:$("#name").val(),EMAIL:$("#EMAIL").val(),rcode:$("#rcode").val(),FKEY:$.md5('USERNAME'+nowtime+',llft,'),tm:new Date().getTime()},
				dataType:'json',
				cache: false,
				success: function(data){
					if("00" == data.result){
